          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 text-gray-500 gap-5 cursor-pointer">
            <div className="">
              <div className="space-y-4">
                <img src="navbar/logo.svg" alt="img" style={{filter:"invert(1)"}}/>
                <p>
              ...
              <div className="">
                <h1 className="text-white font-bold text-lg">RECENT POSTS</h1>
             ...
             <div className="grid grid-cols-1 sm:grid-cols-3 text-gray-500 cursor-pointer gap-5">
                  <div className="">
                  <h1 className="font-bold text-lg text-white"> OUR STORES</h1>
                  ...
                  <div className="">
                  <h1 className="font-bold text-lg text-white"> FOOTER MENU</h1>
                     <ul className="pt-3 space-y-2">
